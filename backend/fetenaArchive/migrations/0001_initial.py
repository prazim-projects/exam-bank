    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authorized_users', models.ManyToManyField(blank=True, help_text='Users authorized and acknowledged by the department.', related_name='authorized_departments', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='exam',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exams', to='fetenaArchive.exam_courses'),
        ),
        migrations.AddField(
